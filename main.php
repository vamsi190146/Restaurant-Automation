    ...
    <footer>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <p class="mb-1">Phone:   9676841869</p>
                        <p class="mb-1">Email:   tadiparthivamsi@gmail.com</p>
                        <p class="mb-1">Address: Tirupati</p>
                    </div>
                    <div class="col-lg-6">
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <p class="mb-0">Copyrights © 2023 Vamsi, All rights reserved.</p>
                    </div>
                    <div class="col-lg-6">
                        <p class="mb-0">Designed By Vamsi</p>
                    </div>
                </div>
            </div>
        </div>
